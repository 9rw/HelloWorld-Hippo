...
export default function Nav() {
  ...
  return (
    <nav className="z-[49] fixed top-0 flex justify-between items-center px-10 py-4 w-full h-[164px] bg-white text-primary-background border-b-2 border-primary-foreground/20 shadow-lg">
